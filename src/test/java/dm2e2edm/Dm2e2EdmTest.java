...
//		new Dm2e2Edm();
		...
		log.debug("{}", Dm2e2Edm.dm2eSuperProperties.get(Dm2e2Edm.dm2eModel.createProperty(NS.CRM.PROP_P79F_BEGINNING_IS_QUALIFIED_BY)));
...
//		assertThat(Dm2e2Edm.edmProperties).contains(Dm2e2Edm.edmModel.createResource(NS.CRM.PROP_P79F_BEGINNING_IS_QUALIFIED_BY));
	...
	public void testSuperClasses()
		...
		Model ret = Dm2e2Edm.convertToEdm(m);
		StringWriter sw = new StringWriter();
		ret.write(sw, "TURTLE");
		log.debug("{}", sw.toString());
	}
